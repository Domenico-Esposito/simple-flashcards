...
export default function ResetStatsScreen() {
	const { resetStats } = useFlashcardsStore();

	const handleResetStats = () => {
		Alert.alert('Reset statistiche', 'Sei sicuro di voler eliminare tutte le statistiche? Questa azione è irreversibile.', [
			{ text: 'Annulla', style: 'cancel' },
			{
				...
				onPress: async () => {
					await resetStats();
					Alert.alert('Completato', 'Le statistiche sono state eliminate.');
				},
			},
		]);
	};
