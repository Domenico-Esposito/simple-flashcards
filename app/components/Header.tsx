...
function LargeScreenHeader({ title, subtitle, showBackButton, actions, headerIconColor, onBackPress }: HeaderLayoutProps) {
	return (
		<XStack backgroundColor="$background" paddingVertical="$3" paddingHorizontal="$4" alignItems="center" gap="$4" minHeight={56}>
			{showBackButton && (
...
function MobileHeader({ title, subtitle, showBackButton, actions, headerIconColor, onBackPress, isModal, insets, maxTitleLength, maxSubtitleLength }: HeaderLayoutProps) {
