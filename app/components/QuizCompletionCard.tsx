					...
					<View backgroundColor={cardBg} borderRadius="$10" padding="$6" elevation={10}>
						...
						<Animated.View style={statsAnimatedStyle}>
							<YStack gap="$3" marginBottom="$5">
								...
								<View backgroundColor={colors.accentBgTint} borderRadius="$4" padding="$4" alignItems="center">
								...
								<View flexDirection="row" gap="$2">
									<View flex={1} backgroundColor={colors.successBgTint} borderRadius="$4" padding="$3" alignItems="center">
									...
									<View flex={1} backgroundColor={colors.warningBgTint} borderRadius="$4" padding="$3" alignItems="center">
										<View flexDirection="row" alignItems="center" gap="$1">
									...
									<View flex={1} backgroundColor={colors.errorBgTint} borderRadius="$4" padding="$3" alignItems="center">
										<View flexDirection="row" alignItems="center" gap="$1">
								...
								{/* Time row */}
								<View backgroundColor={colors.chipBg} borderRadius="$4" padding="$3" alignItems="center">
