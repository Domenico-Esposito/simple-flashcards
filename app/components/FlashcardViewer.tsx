			...
			<View flex={1} paddingTop={insets.top} backgroundColor="$background">
				...
				<View style={{ flex: 1, position: 'relative', overflow: 'visible' }}>
					<GestureDetector gesture={composedGesture}>
						<Animated.View
							style={[
								{ flex: 1, paddingHorizontal: CARD_HORIZONTAL_MARGIN, zIndex: 1 },
								animatedCardStyle,
							]}>
							<View style={{ flex: 1, position: 'relative', overflow: 'visible' }}>
								{/* Front face — Question */}
									...
									<SkiaCardShadow
										...
										<Animated.View style={[{ width: '100%', height: '100%' }, animatedContentStyle]}>
											<View
												...
												{isAnswerOverflow && (
													<View position="absolute" bottom={answerBottomPadding + 16} left={0} right={0} alignItems="center" pointerEvents="box-none">
